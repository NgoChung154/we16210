...
class CategoryController extends Controller
{
    ...
    public function store(CategoryRequest $request)
    {
        //Validate
        // $request->validate([
        //     //name nào sẽ validate dieu kien gi
        //     'name'=>'required|min:6|max:32',
        //     'description'=>'min:6',
        //     'status'=>'required'
            
        // ]);
        // nếu có lỗi trong điều kiện truyền vào thì tự kết thúc  hàm và quay trở lại form kèm biến $errors
    ...
    {
        // $cateUpdate chinh la doi tuong Category cos id = $id
        $cateUpdate = $id;
        ...
        // thuc thi viec luu du lieu mowi vao db
        $cateUpdate->update();
        // Quay ve danh sach
        return redirect()->route('categories.index');
    }
